...
class FocalLoss(nn.Module):
    def __init__(self, gamma=2, eps=1e-10,**kwargs):
        super().__init__()
        self.gamma = gamma
    ...
    def forward(self,  y_pred,y_true):
        ...
        return loss.mean()
criteria=FocalLoss(gamma=5,ignore_index=255)
class FewShotSeg(nn.Module):
    ...
    def calDist(self, fts, prototype, scaler=1):
        """
    ...
    def alignLoss(self, qry_fts, pred, supp_fts, fore_mask, back_mask):
        ...
        for way in range(n_ways):
            ...
            for shot in range(n_shots):
                ...
                # Compute Loss
                loss = loss + criteria(
                    supp_pred, supp_label[None, ...]) / n_shots / n_ways
        return loss
